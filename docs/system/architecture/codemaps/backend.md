...
> **TL;DR**: Authoritative specification and architectural reference for System Backend Architecture & Code Terrain Map within the DBSN platform (docs/system/architecture/codemaps/backend.md).
