...
- **GRI 1:** Classification is determined by the terms of the headings and Section/Chapter notes. This resolves ~90% of classifications. read_file the heading text literally and check every relevant Section and Chapter note before moving on.
...
3. **Apply GRI 1.** read_file the heading terms literally. If only one heading covers the good, classification is decided.
