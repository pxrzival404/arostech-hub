...
### 2b: Choose activate_skill Categories
...
1. read_file each installed SKILL.md
...
4. replace the SKILL.md files in-place at the installation target (NOT the source repo)
5. Fix any path issues found in Step 4

### If optimizing rules:
1. read_file each installed rule .md file
2. Ask the user about their preferences:
   - Test coverage target (default 80%)
   - Preferred formatting tools
   - Git workflow conventions
   - Security requirements
3. replace the rule files in-place at the installation target
