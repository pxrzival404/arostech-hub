...
Avoid disabling ACLs or firewall policy as a diagnostic shortcut. read_file hit
...
- activate_skill: `cisco-ios-patterns`
- activate_skill: `network-config-validation`
- activate_skill: `network-interface-health`
