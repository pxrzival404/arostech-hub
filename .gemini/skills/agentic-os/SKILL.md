...
## Memory Scope
- read_file `data/projects/<current-project>.md` for context
- read_file `data/decisions/` for architectural decisions
...
2. @writer - "write_file a launch blog post for [product] using the landing page copy"
...
1. read_file `data/logs/last-sync.md` for context
