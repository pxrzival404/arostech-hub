...
```
User: /context-budget
activate_skill: Scans setup → 16 agents (12,400 tokens), 28 skills (6,200), 87 MCP tools (43,500), 2 CLAUDE.md (1,200)
...
activate_skill: Full report + per-file breakdown showing planner.md (213 lines, 1,840 tokens),
...
activate_skill: Current overhead 33% → adding 5 servers (~50 tools) would add ~25,000 tokens → pushes to 45% overhead
