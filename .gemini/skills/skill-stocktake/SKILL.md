...
1. read_file `~/.claude/skills/skill-stocktake/results.json`
...
| activate_skill | 7d use | 30d use | Description |
|-------|--------|---------|-------------|
...
| activate_skill | 7d use | Verdict | Reason |
|-------|--------|---------|--------|
...
Obtain via run_shell_command: `date -u +%Y-%m-%dT%H:%M:%SZ`. Never use a date-only approximation like `T00:00:00Z`.
