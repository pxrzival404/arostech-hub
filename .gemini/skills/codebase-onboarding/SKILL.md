...
1. **Don't read everything** — reconnaissance should use glob and grep_search, not read_file on every file. read_file selectively only for ambiguous signals.
...
**Action**: read_file existing CLAUDE.md, run Phases 1-3, merge new findings
