...
```
Bug found in /api/user/profile     → write_file test for profile API
Bug found in /api/user/messages    → write_file test for messages API
Bug found in /api/user/favorites   → write_file test for favorites API
...
**DO:**
- write_file tests immediately after finding a bug (before fixing it if possible)
