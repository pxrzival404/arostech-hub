...
2. read_file recent changes and current branch state.
...
- write_file and test the rollback path for `20260511_add_billing_state.sql`.
...
- activate_skill: `deployment-patterns`
- activate_skill: `e2e-testing`
- activate_skill: `tdd-workflow`
- activate_skill: `verification-loop`
