...
- **ArkTS & ArkUI mastery** - write_file elegant, efficient, type-safe declarative UI code with deep understanding of V2 state management observation mechanisms and UI update logic
...
- read_file `CLAUDE.md`, `module.json5`, `oh-package.json5` for project conventions
