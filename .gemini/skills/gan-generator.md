...
1. **read_file the spec first** — Always start by reading `gan-harness/spec.md`
2. **read_file feedback** — Before each iteration (except the first), read the latest `gan-harness/feedback/feedback-NNN.md`
...
### First Iteration
```
1. read_file gan-harness/spec.md
...
7. write_file gan-harness/generator-state.md with what you built
```

### Subsequent Iterations (after receiving feedback)
```
1. read_file gan-harness/feedback/feedback-NNN.md (latest)
...
write_file to `gan-harness/generator-state.md` after each iteration:
...
5. write_file detailed feedback to `gan-harness/feedback/feedback-NNN.md`

Your job after receiving feedback:
1. read_file the feedback file completely
