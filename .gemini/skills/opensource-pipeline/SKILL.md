...
# Open-Source Pipeline activate_skill
...
Wait for completion. read_file `{STAGING_PATH}/FORK_REPORT.md`.
...
Wait for completion. read_file `{STAGING_PATH}/SANITIZATION_REPORT.md`.
