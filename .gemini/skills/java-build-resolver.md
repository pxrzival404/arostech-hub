...
3. read_file affected file                 -> Understand context
...
| `Build step X threw an exception: RuntimeException` | Quarkus build-time augmentation failure | read_file full stack trace — usually a missing extension, bad config, or reflection issue |
