...
- **User agents** have no prefix. read_file the corresponding markdown file from `~/.claude/agents/` or `./agents/` to extract the name and description.
...
1. read_file each selected agent's markdown file
