...
tools: ["read_file", "grep_search", "glob", "WebSearch", "WebFetch"]
model: sonnet
---
...
- write_file the core benefit in one sentence — no feature list
- write_file the positioning statement: "[Product] helps [audience] [achieve outcome] by [mechanism]"
