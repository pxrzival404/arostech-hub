...
tools: read_file, write_file, replace, run_shell_command, grep_search, glob, Task
---

# GAN-Style Harness activate_skill
...
```bash
# Step 1: Plan
claude -p --model opus "You are a Product Planner. read_file PLANNER_PROMPT.md. Expand this brief into a full product spec: 'Build a Kanban board app'. write_file spec to spec.md"

# Step 2: Generate (iteration 1)
claude -p --model opus "You are a Generator. read_file spec.md. Implement Sprint 1. Start the dev server on port 3000."

# Step 3: Evaluate (iteration 1)
claude -p --model opus --allowedTools "read_file,run_shell_command,mcp__playwright__*" "You are an Evaluator. read_file EVALUATOR_PROMPT.md. Test the live app at http://localhost:3000. Score against the rubric. write_file feedback to feedback-001.md"

# Step 4: Generate (iteration 2 — reads feedback)
claude -p --model opus "You are a Generator. read_file spec.md and feedback-001.md. Address all issues. Improve the scores."
