...
4. **write_file observable criteria** — each AC-NNN describes a starting condition, trigger, expected outcome, prohibited side effect, verification method, and priority; no vague words like "correctly" or "securely" without evidence
...
activate_skill reviews it for missing scope boundaries, unverifiable requirements ("the system shall be fast"),
...
### 4. write_file Acceptance Criteria
