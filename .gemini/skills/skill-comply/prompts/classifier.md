...
- A write_file to "test_calculator.py" is a test file write, even if the content is implementation-like
- A write_file to "calculator.py" is an implementation write, even if it contains test helpers
- A run_shell_command running "pytest" that outputs "FAILED" is a RED phase test run
- A run_shell_command running "pytest" that outputs "passed" is a GREEN phase test run
