...
```jsonl
{"timestamp":"2025-01-22T10:30:00Z","event":"tool_start","session":"abc123","tool":"replace","input":"...","project_id":"a1b2c3d4e5f6","project_name":"my-react-app"}
{"timestamp":"2025-01-22T10:30:01Z","event":"tool_complete","session":"abc123","tool":"replace","output":"...","project_id":"a1b2c3d4e5f6","project_name":"my-react-app"}
{"timestamp":"2025-01-22T10:30:05Z","event":"tool_start","session":"abc123","tool":"run_shell_command","input":"npm test","project_id":"a1b2c3d4e5f6","project_name":"my-react-app"}
{"timestamp":"2025-01-22T10:30:10Z","event":"tool_complete","session":"abc123","tool":"run_shell_command","output":"All tests pass","project_id":"a1b2c3d4e5f6","project_name":"my-react-app"}
```
...
- Always uses grep_search before replace
- Prefers read_file over run_shell_command cat
- Uses specific run_shell_command commands for certain tasks
...
| General best practices | **global** | "write_file tests first", "Always handle errors" |
| Tool workflow preferences | **global** | "grep_search before replace", "read_file before write_file" |
...
Given observations:
```jsonl
{"event":"tool_start","tool":"grep_search","input":"pattern: useState","project_id":"a1b2c3","project_name":"my-app"}
{"event":"tool_complete","tool":"grep_search","output":"Found in 3 files","project_id":"a1b2c3","project_name":"my-app"}
{"event":"tool_start","tool":"read_file","input":"src/hooks/useAuth.ts","project_id":"a1b2c3","project_name":"my-app"}
{"event":"tool_complete","tool":"read_file","output":"[file content]","project_id":"a1b2c3","project_name":"my-app"}
{"event":"tool_start","tool":"replace","input":"src/hooks/useAuth.ts...","project_id":"a1b2c3","project_name":"my-app"}
```

Analysis:
- Detected workflow: grep_search → read_file → replace
- Frequency: Seen 5 times this session
- **Scope decision**: This is a general workflow pattern (not project-specific) → **global**
- Create instinct:
  - trigger: "when modifying code"
  - action: "Search with grep_search, confirm with read_file, then replace"
  - confidence: 0.6
  - domain: "workflow"
  - scope: "global"

## Integration with activate_skill Creator

When instincts are imported from activate_skill Creator (repo analysis), they have:
