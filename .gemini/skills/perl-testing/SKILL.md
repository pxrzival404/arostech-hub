...
```perl
# Step 1: RED — write_file a failing test
# t/unit/calculator.t
use v5.36;
use Test2::V0;
...
# Step 2: GREEN — write_file minimal implementation
# lib/Calculator.pm
package Calculator;
use v5.36;
use Moo;
...
- **Follow TDD**: write_file tests before implementation (red-green-refactor)
