...
allowed-tools: read_file, write_file, replace, run_shell_command, grep_search, glob
---
...
6. write_file the next iteration as a falsifiable experiment, not a vague "improve model" task.
