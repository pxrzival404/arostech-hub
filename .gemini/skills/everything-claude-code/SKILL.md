...
## When to Use This activate_skill
...
### Add Cross Harness activate_skill Copies
...
**Steps**:
1. replace SKILL.md, agent, or command files to address reviewer comments
...
**Example commit sequence**:
```
replace SKILL.md, agent, or command files to address reviewer comments
