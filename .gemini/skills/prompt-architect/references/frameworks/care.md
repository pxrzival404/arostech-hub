...
**Examples:**
- "write_file a set of 5 interview questions for testing navigation usability..."
...
**Before CARE:**
"write_file interview questions for our usability study."
...
ASK:
write_file 6 interview questions for the post-task debrief, focusing on
...
**Before CARE:**
"write_file patient education content about diabetes management."
...
ASK:
write_file a 200-word article explaining why blood sugar monitoring matters
...
**Before CARE:**
"write_file error messages for our app."
...
ASK:
write_file error messages for these 3 error states: (1) file format not supported,
