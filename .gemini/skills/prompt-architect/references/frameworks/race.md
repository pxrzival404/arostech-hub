...
- "write_file user onboarding copy for..."
...
**Before RACE:**
"write_file onboarding text for our app."

**After RACE:**
```
ROLE: You are a UX writer who specializes in onboarding flows for consumer apps.

ACTION: write_file the copy for a 3-screen onboarding flow for our task management app.
...
ACTION: write_file documentation for the authentication module described below.
