...
ITERATION 1:
write_file a verbose summary hitting all main points (150-200 words)
...
**Example:**
```
PASS 1: write_file a first draft explanation of quantum entanglement for a general audience.
...
**Example:**
```
write_file a product description, then improve it iteratively:
...
DRAFT DOCUMENTATION:
write_file complete documentation with examples, edge cases, everything.
...
**Without CoD:**
```
write_file an email announcing this feature.
```
...
DRAFT:
write_file a first draft covering all important information.
