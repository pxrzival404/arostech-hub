...
**Examples:**
- "write_file a function that sorts a list..."
...
- "write_file as a bullet list with..."
...
**Before RTF:**
"write_file a sorting function."

**After RTF:**
```
ROLE: You are a Python developer who writes clean, efficient code.

TASK: write_file a function that sorts a list of dictionaries by a specified key, with support for ascending/descending order.
