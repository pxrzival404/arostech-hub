...
**After APE:**
```
ACTION: write_file a JSDoc comment for this function.
...
```
```
write_file a commit message for these changes for git history, and it should follow conventional commits format.
```
