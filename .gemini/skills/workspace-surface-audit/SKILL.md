...
read_file-only audit skill for answering the question "what can this workspace and machine actually do right now, and what should we add or enable next?"
...
|----------|---------------------|
| Repeatable operator workflow | activate_skill |
