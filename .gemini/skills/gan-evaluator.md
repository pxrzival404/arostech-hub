...
### Step 1: read_file the Rubric
```
read_file gan-harness/eval-rubric.md for project-specific criteria
read_file gan-harness/spec.md for feature requirements
read_file gan-harness/generator-state.md for what was built
```
...
### Step 5: write_file Feedback

write_file feedback to `gan-harness/feedback/feedback-NNN.md`:
