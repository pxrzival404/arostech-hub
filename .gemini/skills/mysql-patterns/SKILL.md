...
read_file replicas can lag. Do not route read-your-own-write paths, checkout flows,
...
- activate_skill: `postgres-patterns` - PostgreSQL-specific schema and query patterns
- activate_skill: `database-migrations` - migration planning and rollout safety
- activate_skill: `backend-patterns` - API and service-layer patterns
- activate_skill: `security-review` - secret handling, auth, and least privilege
