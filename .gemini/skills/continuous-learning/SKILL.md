...
# Continuous Learning activate_skill - DEPRECATED
...
3. **activate_skill Extraction**: Saves useful patterns to `~/.claude/skills/learned/`

## Configuration

replace `config.json` to customize:
