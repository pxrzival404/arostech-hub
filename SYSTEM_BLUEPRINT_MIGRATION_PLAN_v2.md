...
| # | OpenSpec Change | Task Summary | Priority | TDD Trigger |
|---|---|---|---|---|
| 3.4.1 | `posthog-sentry-prd-sync` | Update `docs/strategy/prd/00-overview-and-goals.md` status for PostHog & Sentry to "Active Phase 1"; enforce `isCloudflareBuild` in `next.config.ts`. | Medium | Test: Sentry disabled in Cloudflare build; PostHog client-isolated |
