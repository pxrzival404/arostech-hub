 ...
 *
 * Schema untuk project/portfolio Dubusun (case study pekerjaan).
 * Field `subdomain` untuk multi-tenant filter.
 */
...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      title: "Subdomain",
      type: "string",
      description: "Sub-domain Dubusun yang pakai project ini.",
      initialValue: "pju",
      options: {
        list: [
          { title: "PJU", value: "pju" },
          { title: "Sentradaya", value: "sentradaya" },
    ...
    defineField({
      ...
      options: {
        list: [
          { title: "PJU", value: "pju" },
          { title: "Panel Surya", value: "panelsurya" },
          { title: "Penangkal Petir", value: "penangkalpetir" },
          { title: "Baterai", value: "baterai" },
        ],
      },
